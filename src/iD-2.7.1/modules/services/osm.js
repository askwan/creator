...
import Wicket from '@/script/wicket'
import parseObjectToOsm from '@/script/parseObjectToOsm'
...
export default {
  ...
  loadTiles: function (projection, dimensions, callback, context) {
    if (_off) return
